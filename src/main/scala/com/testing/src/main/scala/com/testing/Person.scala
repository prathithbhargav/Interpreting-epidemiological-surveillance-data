...
case class Person(id: Long,
                  ...
                  essentialWorker:Int,
                  cemeteryId:Long,
                  infectingAgent: Long = -20000, // this is what we have added
                  beingTested:Int = 0,
                  ...
                  infectedAt: String = "", // this is also what we added
                  agentsInfected: Int = 0, // this is also what we added
...
//  }
  ...
  def isInfected: Boolean = infectionState == Asymptomatic || infectionState == Presymptomatic || infectionState == MildlyInfected || infectionState == SeverelyInfected || infectionState == Hospitalized
